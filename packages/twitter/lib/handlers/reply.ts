...
function replyToTweetHandler(job: Job<InputVariables, Headers>, complete: CompleteFn<OutputVariables>, worker: ZBWorker<InputVariables, Headers, OutputVariables>) {
